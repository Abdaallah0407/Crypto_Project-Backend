    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_quantity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='products.itemdevice', verbose_name='Доступная цена за количевство апаратов')),
            ],
            options={
