...
from .views import APIDeviceResetItem,APIResetProductUpdateViewSet,APITableProductUpdateViewSet, SumTable, APITableProductViewSet, APITable_HeadersViewSet, DestroyAPICartItem, APICartItemProduct, FillTable, NextPreviouTable, APIDeviceView, APIDeviceItemProduct, APIDeviceUpdateItem, PreviouTable
...
urlpatterns = [
    ...
    path("api/reset-table/", APIResetProductUpdateViewSet.as_view(),
         name="reset-table"),
    path("api/reset-device/", APIDeviceResetItem.as_view(),
         name="reset-device"),
